                ...
                <div class="box-hd clearfix">
                    ...
                    <div class="filter">
                        ...
                        <dl>
                            ...
                            @foreach($res as $k)
                            <dd bussType="1" class="" ><a class="clickstat" href="http://www.huya.com/g_ol" eid="click/list/allgame/online"   eid_desc="点击/列表页/全部游戏/网游竞技">{{$k->class_name}}</a></dd>
                            @endforeach
                        </dl>
                    ...
                    <ul class="game-list clearfix" id="js-game-list">
                        ...
                        <li class="game-list-item">
                        	...
                        	<a target="_blank" href="http://www.huya.com/g/lol" class="pic new-clickstat" report='{"eid":"click/postion","position":"gameList/gameCard/1","game_id":"1"}'>
                            	...
                            	<img class="pic-img" data-original="http://huyaimg.dwstatic.com/cdnimage/game/1-S.jpg?t=1500685200" src="images/default_game_pc.jpg" alt="英雄联盟" title="英雄联盟" onerror="this.onerror='';this.src='images/default_game_pc.jpg'">
