            ...
            <div class="scroll-content">
                <div class="nav-section" style="padding-bottom:0">
                   ...
                   <ul class="icon-filter">
                        ...
                        <li>
                            <a menu="noble" href="http://www.lives.com/sub">
                        ...
                        <div class="mod-bd">
                            <div class="user-basic">
                                <dl>
                                    ...
                                    <dd>
                                        <span>我的Y币<i></i></span>
                                            <a href="https://pay.duowan.com/userDepositDWAction.action?timestamp=1500113020" target="_blank">充值</a>
                                            <!-- 第三方登录 -->
                                            <!-- <a href="javascript:void(0);" onclick="openThirdLoginTips();">充值</a>  -->
                                        <a href="https://pay.duowan.com/userInformationAction.action?timestamp=1500113020" target="_blank">查看</a>
                                    </dd>
                                </dl>
