...
<!-- 上传头像 e -->
<link href="css/new_home_index_20170112.css" rel="stylesheet"/>
<!-- 图片裁剪样式 -->
...
<div class="admin-menu">
    <div class="content">
        ...
        <div class="main-col">
            <div class="scroll-content">
                <div class="mod mod-user-center">
                    ...
                    <img class="img_hover" src="images/header_hover.png" alt="上传图像">
                        ...
                        <input type="hidden" name="uid" value="1756633135">
                    ...
                    <div class="user_info">
                        ...
                        <!-- <p class="yy_num"><span>YY:</span><span id="YY">2009239504</span></p> -->
                                                <!-- 非第三方登陆，显示修改昵称、密码 -->
                        <div class="change">
                            <p class="change_top"><img src="images/warn.png" alt="">字段包含敏感字符，请重新输入</p>
            ...
            <!-- 经验值获取 -->
                        <!-- 经验值获取·新手任务  -->
            <div class="mod mod-basic" id="grow_greener">
                <div class="mod-hd">
                    <h4>经验值获取·新手任务</h4>
                    <!-- <span class="line line-income"></span> -->
                                ...
                                <div class="task">
                    <!-- <i class="task_1"></i> -->
                    <img src="images/xinshou_dingyue.png" alt="订阅主播">
                    <p class="title">订阅主播</p>
                                            <!-- 进度条 -->
                        <div class="result_contact">
                            <span class="contact">
                                <span class="number"><b class="numTask">0</b>/<b class="totalTask">5</b></span>
                ...
                <div class="task_line"></div>
                                <div class="task">
                    <!-- <i class="task_2"></i> -->
                    <img src="images/xinshou_touxiang.png" alt="设置头像">
                    <p class="title">设置头像</p>
                                                                        <!-- 领取 -->
                            <div class="result">
                                <a class="btn get_task" href="javascript:void(0);" data-exper="20" task-id="142">领取</a>
                            </div>
                                                            </div>
                <div class="task_line"></div>
                                <div class="task">
                    <!-- <i class="task_3"></i> -->
                    <img src="images/xinshou_songli.png" alt="送出虎粮">
                    <p class="title">送出虎粮</p>
                                            <!-- 进度条 -->
                        <div class="result_contact">
                            <span class="contact">
                                <span class="number"><b class="numTask">0</b>/<b class="totalTask">1</b></span>
                                <span class="part" style="width:0%;"></span>
                            </span>
                        </div>
                                    </div>
                <div class="task_line"></div>
                                <div class="task">
                    <!-- <i class="task_4"></i> -->
                    <img src="images/xinshou_ewai.png" alt="额外奖励">
                    <p class="title">额外奖励</p>
                                            <!-- 进度条 -->
                        <div class="result_contact">
                            <span class="contact">
                                <span class="number"><b class="numTask">1</b>/<b class="totalTask">3</b></span>
                                <span class="part" style="width:33%;"></span>
                            </span>
                        </div>
                                    </div>
                <div class="task_line"></div>
...
<script src="js/moment.js?t=20150610"></script>
<!-- <script type="text/javascript" src="http://a.dwstatic.com/huya/icenter/2.1/js/index.js?t=20160303v1"></script> -->
<!-- add js -->
<!-- 图片裁剪 -->
<script type="text/javascript" src="js/imgPre.js"></script>
<script type="text/javascript" src="js/jquery.imgareaselect.pack.js"></script>
<script type="text/javascript" src="js/imgCut.js"></script>
<!-- 图片裁剪end -->
<!-- <script type="text/javascript" src="http://a.dwstatic.com/huya/icenter/2.4/js/new_home.js"></script> -->
<!-- <script type="text/javascript" src="http://a.dwstatic.com/huya/icenter/2.10/js/new_home_second.js"></script> -->
<!-- 贵族续费 -->
<!-- <script src="js/js&f=lego.popupbox.js"></script>
<script src="http://a.dwstatic.com/huya/icenter/2.5/js/guizutequan.js"></script> -->
<!-- 贵族续费end -->
<script type="text/javascript" src="js/new_home_20170220.js"></script>
<!-- end -->
<!-- 第三方登陆修改密码 -->
<!-- 第三方登陆修改密码 -->
