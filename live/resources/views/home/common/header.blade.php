...
<div class="modal in" id="login-modal" }> <a class="close" data-dismiss="modal">×</a>
        ...
        <ul class="login-bind-tp">
          <li class="qweibo"> <a href="#" onclick='toLogin()'><em>&nbsp;</em> QQ登录</a> </li>
          <li class="sina"> <a href="https://api.weibo.com/oauth2/authorize?client_id=4021128813&redirect_uri=http://zhipeng.com133.com/weibo 

"><em>&nbsp;</em> 微博登录</a> </li>
          <li class="douban"> <a href="http://www.xwcms.net 

"><em>&nbsp;</em> 豆瓣登录</a> </li>
        </ul>
        <p>或者使用已有帐号登陆：</p>
        <form class="login-form clearfix" method="post" action="log">
          <div class="form-arrow"></div>
          <input name="username" type="text" placeholder="邮箱,电话,用户名">
...
<div class="modal in" id="signup-modal" > <a class="close" data-dismiss="modal">×</a>
  <h1>注册</h1>
  <ul class="login-bind-tp">
    <li class="qweibo"> <a href="http://www.xwcms.net 

"><em>&nbsp;</em> QQ登录</a> </li>
    <li class="sina"> <a href="http://www.xwcms.net 
...
"><em>&nbsp;</em> 豆瓣登录</a> </li>
  ...
  <p>或者使用邮箱注册：</p>
  <form class="signup-form clearfix" method="post" action="sign">
    <p class="error"></p>
