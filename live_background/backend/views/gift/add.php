                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="col-xs-12 col-sm-3">
                                <input id="form-field-1" v-model="name" name="gift_name" placeholder=" nav name.. " class="col-xs-10 col-sm-12" type="text">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="col-xs-12 col-sm-3">
                                <input id="form-field-1" v-model="name" name="gift_money" placeholder=" price.. " class="col-xs-10 col-sm-12" type="text">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
