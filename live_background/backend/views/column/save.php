    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method="post" action="?r=column/save" enctype="multipart/form-data">
                    <input type="hidden" name="class_id" value="<?php echo $class_a['class_id'] ?>" />
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 分类名称 </label>

                        <div class="col-sm-9">
                            <div class="col-xs-12 col-sm-3">
                                <input id="form-field-1" v-model="name" name="class_name" value="<?php  echo $class_a['class_name'] ?> " class="col-xs-10 col-sm-12" type="text">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-3">
                                ...
                                <select name="class_p_id" id="">
                                    ...
                                    <?php foreach($class as $v){ ?>
                                        <option <?php if($v['class_id']==$class_a['class_p_id']){ ?> selected="selected" <?php  } ?> value="<?php echo $v['class_id'] ?>"><?php echo $v['class_name'] ?></option>
                                    <?php } ?>
                                </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="col-xs-12 col-sm-3">
                                <input type="file" name="file"  readonly value="<?php echo $class_a['class_path'] ?>"/>
                                <img src="<?php echo $class_a['class_path'] ?>" alt="加载失败" height="90" width="120"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
